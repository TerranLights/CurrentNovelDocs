...
- [x] Setting/era confirmed and cross-checked against shared-universe timeline — 2149, Santa Rosa, Cascadia Republic
- [x] Naming *conventions* settled
- [x] Structural conventions (verse/prose, POV, tense, scene-break notation) settled — verse novel, stanza-per-row tables, `***` scene breaks
- [x] Title settled — *Streetside Harmonies*
